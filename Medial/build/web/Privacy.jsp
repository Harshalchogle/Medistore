<%-- 
    Document   : Privacy
    Created on : 19 Jan, 2020, 8:17:13 PM
    Author     : harshal
--%>
...
<ul>
    ...
    <li>
        <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Medistore.</p>
          </li>
...
<ul>
          <li>By visiting this page on our website:localhost:8080</li>
      </ul>      
                   </div>
                        </div>
                    </div>
