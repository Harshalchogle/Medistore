    ...
    public void Writedata()
    {
         try 
        {
          ...
          Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/medical","root","1234");
            PreparedStatement ps=con.prepareStatement("insert into products(Product_code,Product_Name,Company_Name,Description,Description2,Price,Category,Quantity,Product_Photo) values(?,?,?,?,?,?,?,?,?)");
